...
public class WritingJob implements IWorker {
  ...
  public void execute(Config config, int workerID,
    ...
    try {
      TweetBufferedOutputWriter outputWriter = new TweetBufferedOutputWriter(Context.FILE_BASE + "/data/input-" + workerID);
      ...
      TweetBufferedOutputWriter outputWriter2 = new TweetBufferedOutputWriter(Context.FILE_BASE + "/data/second-input-" + workerID);
  ...
  public static void main(String[] args) {
    ...
    twister2Job = Twister2Job.newBuilder()
        ...
        .addComputeResource(1, 24000, Context.PARALLELISM)
